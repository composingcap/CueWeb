...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 173.0, 361.0, 58.0, 22.0 ],
					"presentation_rect" : [ 173.0, 361.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 361.0, 64.0, 22.0 ],
					"presentation_rect" : [ 238.0, 361.0, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 931.5, 244.0, 138.0, 22.0 ],
					"presentation_rect" : [ 931.5, 244.0, 138.0, 22.0 ],
					"text" : "Error-Check the console"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 743.0, 503.0, 87.0, 22.0 ],
					"presentation_rect" : [ 743.0, 503.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 791.5, 550.5, 176.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 281.0, 279.0, 124.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1019.0, 14.353206, 105.114716000000001, 109.293588501529044 ],
					"pic" : "Macintosh HD:/Users/flo/c74/max/node-externs/pkgstatic/icon.png",
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 105.114715576171875, 109.293588060851476 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 689.75, 652.0, 323.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 115.75, 78.293586730957031, 202.0, 27.0 ],
					"text" : "Examples Downloader",
					"textcolor" : [ 0.996078014373779, 0.996078014373779, 0.996078014373779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.5, 338.0, 84.0, 35.0 ],
					"presentation_linecount" : 2,
					"presentation_rect" : [ 388.5, 338.0, 84.0, 35.0 ],
					"text" : ";\rmax reveal $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 388.5, 236.5, 22.0, 22.0 ],
					"presentation_rect" : [ 388.5, 236.5, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.5, 271.5, 182.0, 22.0 ],
					"presentation_rect" : [ 388.5, 271.5, 182.0, 22.0 ],
					"text" : "Usermax:/Library/n4m-examples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 388.5, 303.5, 128.0, 22.0 ],
					"presentation_rect" : [ 388.5, 303.5, 128.0, 22.0 ],
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.321569, 0.2, 0.003922, 1.0 ],
					"bgcolor2" : [ 0.270588, 0.168627, 0.0, 1.0 ],
					"bgfillcolor_angle" : 270.0,
					"bgfillcolor_autogradient" : 0.0,
					"bgfillcolor_color" : [ 0.2, 0.2, 0.2, 1.0 ],
					"bgfillcolor_color1" : [ 0.321569, 0.2, 0.003922, 1.0 ],
					"bgfillcolor_color2" : [ 0.270588, 0.168627, 0.0, 1.0 ],
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.5, 203.5, 234.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 279.0, 234.0, 25.0 ],
					"text" : "Reveal the downloaded examples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 794.0, 457.0, 58.0, 22.0 ],
					"presentation_rect" : [ 794.0, 457.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 863.0, 503.0, 29.5, 22.0 ],
					"presentation_rect" : [ 863.0, 503.0, 29.5, 22.0 ],
					"text" : "set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 863.0, 457.0, 63.0, 22.0 ],
					"presentation_rect" : [ 863.0, 457.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 931.5, 552.0, 189.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 412.0, 279.0, 300.0, 23.0 ],
					"text" : "Not started",
					"textcolor" : [ 0.996078014373779, 0.996078014373779, 0.996078014373779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 931.5, 457.0, 72.0, 22.0 ],
					"presentation_rect" : [ 931.5, 457.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 931.5, 416.0, 29.0, 22.0 ],
					"presentation_rect" : [ 931.5, 416.0, 29.0, 22.0 ],
					"text" : "thru"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 858.875, 244.0, 55.0, 22.0 ],
					"presentation_rect" : [ 858.875, 244.0, 55.0, 22.0 ],
					"text" : "All done!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 786.25, 271.5, 72.0, 22.0 ],
					"presentation_rect" : [ 786.25, 271.5, 72.0, 22.0 ],
					"text" : "Unzipping..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.25, 317.0, 191.0, 22.0 ],
					"presentation_rect" : [ 716.25, 317.0, 191.0, 22.0 ],
					"text" : "Downloading examples package..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 641.0, 361.0, 97.0, 22.0 ],
					"presentation_rect" : [ 641.0, 361.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 641.0, 207.0, 382.125, 22.0 ],
					"presentation_rect" : [ 641.0, 207.0, 382.125, 22.0 ],
					"text" : "sel STARTING DOWNLOADING UNZIPPING COMPLETE ERROR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 58.0, 255.0, 22.0, 22.0 ],
					"presentation_rect" : [ 58.0, 255.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 90.5, 241.0, 22.0 ],
					"presentation_rect" : [ 58.0, 90.5, 241.0, 22.0 ],
					"text" : "https://github.com/Cycling74/n4m-examples"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 131.5, 129.0, 35.0 ],
					"presentation_linecount" : 2,
					"presentation_rect" : [ 58.0, 131.5, 129.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 58.0, 58.0, 22.0, 22.0 ],
					"presentation_rect" : [ 58.0, 58.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 244.0, 169.0, 74.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 55.75, 193.0, 210.0, 57.0 ],
					"text" : "You can also download the repository automatically using this button",
					"textcolor" : [ 0.996078014373779, 0.996078014373779, 0.996078014373779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 203.5, 169.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 295.75, 209.0, 169.0, 25.0 ],
					"text" : "Download the examples"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 155.0, 27.5, 185.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 375.0, 139.5, 185.0, 23.0 ],
					"text" : "to view the repository",
					"textcolor" : [ 0.996078014373779, 0.996078014373779, 0.996078014373779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 27.5, 75.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 295.75, 139.5, 75.0, 25.0 ],
					"text" : "Click here"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 21.0, 378.0, 23.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 55.75, 128.5, 202.0, 40.0 ],
					"text" : "There are many, many more examples available online",
					"textcolor" : [ 0.996078014373779, 0.996078014373779, 0.996078014373779, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 900.0, 86.5, 65.0, 22.0 ],
					"presentation_rect" : [ 900.0, 86.5, 65.0, 22.0 ],
					"text" : "route state"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 58.0, 401.0, 171.0, 22.0 ],
					"presentation_rect" : [ 58.0, 401.0, 171.0, 22.0 ],
...
,
					"text" : "node.script n4m.downloader.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 361.0, 107.0, 22.0 ],
					"presentation_rect" : [ 58.0, 361.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 293.0, 100.0, 22.0 ],
					"presentation_rect" : [ 58.0, 293.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 58.0, 325.0, 128.0, 22.0 ],
					"presentation_rect" : [ 58.0, 325.0, 128.0, 22.0 ],
					"text" : "conformpath max boot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 675.0, 614.0, 247.0, 105.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.114715576171875, 74.293586730957031, 623.88525390625, 35.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 58.293587000000002, 921.5, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 265.5, 725.0, 50.0 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 67.5, 693.0, 601.0, 693.0, 601.0, 75.5, 909.5, 75.5 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 650.5, 397.0, 941.0, 397.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 725.75, 352.5, 941.0, 352.5 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 795.75, 306.0, 941.0, 306.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 868.375, 292.0, 941.0, 292.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
		...
		"autosave" : 0,
		"locked_bgcolor" : [ 0.160784, 0.168627, 0.180392, 1.0 ],
		"editing_bgcolor" : [ 0.160784, 0.168627, 0.180392, 1.0 ]
	}
