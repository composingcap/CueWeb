...
function frameChange(data){
  ...
  */
  ...
  if (data !== undefined){
    ...
    else if ((data[0] === thisEnsemble) || (thisEnsemble === "global")){
       alertNumber = 0;
      textMsg = "none";
      textMsg2 = "none";
      nextCue = data[1];
...
function countdown(seconds){
    ...
    textSize(squareSide/15);
    text(String(textMsg2), width/2, 7*height/8);
